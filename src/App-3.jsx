...
export default function WorkshopSite() {
  ...
  const nextSerialSuggestion = () => {
    ...
    return "NABD-" + String(n).padStart(3, "0");
  };
      ...
      {view === "certificates" && isAdmin && (
        <section className="max-w-5xl mx-auto px-5 pb-16 pt-10 scroll-mt-20">
          ...
          <p className="text-xs text-[#6B7280] mb-5 leading-relaxed">
            كل شهادة تحصل على رقم تسلسلي فريد ورمز QR. الرمز يفتح صفحة توثيق تلقائية بهذا الموقع تُظهر اسم المشارك ورقم الشهادة. اطبع الرمز أو ألصقه على الشهادة الورقية.
          </p>
