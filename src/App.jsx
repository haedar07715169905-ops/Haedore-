                    ...
                    <div className="relative">
                      ...
                      {hero.icon && (
                        <div
                          ...
                          style={{ backgroundColor: "#FFFFFF", border: "1.5px solid #E8A33D" }}
                        >
            ...
            <div className="relative mb-4">
              ...
              {hero.icon && (
                <div
                  ...
                  style={{ backgroundColor: "#FFFFFF", border: "2px solid #E8A33D" }}
                >
              ...
              <Field label="أيقونة التخصص (تظهر بجانب اسمه)">
                ...
                {heroForm.icon && (
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-[11px] text-[#6B7280]">معاينة الأيقونة</span>
                  </div>
                )}
              </Field>
