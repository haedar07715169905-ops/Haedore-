...
export default function WorkshopSite() {
  ...
  const loadAll = useCallback(async () => {
    try {
      const [w, s, c, st] = await Promise.all([
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6 w-full">
            {statsItems.map((stat, idx) => {
              ...
              return (
                <div
                  key={stat.id}
                  className="flex flex-col items-center gap-1 rounded-2xl px-7 py-6 min-w-[150px]"
                  ...
                  {isAdmin && (
                    <div className="flex items-center gap-1 mt-2">
                      <button
                        ...
                        className="w-6 h-6 flex items-center justify-center rounded-md border border-[#D9D4C6] text-[#6B7280] hover:text-[#1F2430] hover:border-[#E8A33D] bg-white"
                      >
                        <ChevronUp size={12} />
                      </button>
                      <button
                      ...
                      {confirmDelete && confirmDelete.type === "stat" && confirmDelete.id === stat.id ? (
                        ...
                        <button
                          ...
                          className="w-6 h-6 flex items-center justify-center rounded-md border border-[#D9D4C6] text-[#6B7280] hover:text-[#C1502E] hover:border-[#C1502E] bg-white"
                        >
                          <Trash2 size={12} />
                        </button>
                      )}
